...
std::shared_ptr<ISensorEndpointBase> SensorEndpointFactory::create(const SensorEndpointConfig& config) {
...
std::vector<std::shared_ptr<ISensorEndpointBase>> SensorEndpointFactory::create_batch(
    const std::vector<SensorEndpointConfig>& configs) {
    
    std::vector<std::shared_ptr<ISensorEndpointBase>> endpoints;
...
std::shared_ptr<ISensorEndpointBase> SensorEndpointFactory::create_ds18b20_endpoint(const SensorEndpointConfig& config) {
...
std::shared_ptr<ISensorEndpointBase> SensorEndpointFactory::create_analog_humidity_endpoint(const SensorEndpointConfig& config) {
